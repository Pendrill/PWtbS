...
public class StartTalkingToLoretto : MonoBehaviour {
    ...
    void Start()
    {
        ...
        thoughtBubble_1.GetComponent<NewThoughtBubble>().nextThoughtBubble = Loretto.GetComponent<StartTalkingToLoretto>().TB1;
        thoughtBubble_2.GetComponent<NewThoughtBubble>().nextThoughtBubble = Loretto.GetComponent<StartTalkingToLoretto>().TB2;
        thoughtBubble_3.GetComponent<NewThoughtBubble>().nextThoughtBubble = Loretto.GetComponent<StartTalkingToLoretto>().TB3;
        thoughtBubble_1.GetComponent<NewThoughtBubble>().thoughtBubbleText_1 = Loretto.GetComponent<StartTalkingToLoretto>().thoughtBubbleText_1;
        thoughtBubble_1.GetComponent<NewThoughtBubble>().thoughtBubbleText_2 = Loretto.GetComponent<StartTalkingToLoretto>().thoughtBubbleText_2;
        thoughtBubble_1.GetComponent<NewThoughtBubble>().thoughtBubbleText_3 = Loretto.GetComponent<StartTalkingToLoretto>().thoughtBubbleText_3;
        thoughtBubble_2.GetComponent<NewThoughtBubble>().thoughtBubbleText_1 = Loretto.GetComponent<StartTalkingToLoretto>().thoughtBubbleText_1;
        thoughtBubble_2.GetComponent<NewThoughtBubble>().thoughtBubbleText_2 = Loretto.GetComponent<StartTalkingToLoretto>().thoughtBubbleText_2;
        thoughtBubble_2.GetComponent<NewThoughtBubble>().thoughtBubbleText_3 = Loretto.GetComponent<StartTalkingToLoretto>().thoughtBubbleText_3;
        thoughtBubble_3.GetComponent<NewThoughtBubble>().thoughtBubbleText_1 = Loretto.GetComponent<StartTalkingToLoretto>().thoughtBubbleText_1;
        thoughtBubble_3.GetComponent<NewThoughtBubble>().thoughtBubbleText_2 = Loretto.GetComponent<StartTalkingToLoretto>().thoughtBubbleText_2;
        thoughtBubble_3.GetComponent<NewThoughtBubble>().thoughtBubbleText_3 = Loretto.GetComponent<StartTalkingToLoretto>().thoughtBubbleText_3;
        originalThoughtBubble_1 = thoughtBubble_1.GetComponent<NewThoughtBubble>().nextThoughtBubble;
        originalThoughtBubble_2 = thoughtBubble_2.GetComponent<NewThoughtBubble>().nextThoughtBubble;
        originalThoughtBubble_3 = thoughtBubble_3.GetComponent<NewThoughtBubble>().nextThoughtBubble;
